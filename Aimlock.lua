-- // Dependencies
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/IrisDevelopment/Aiming/main/Load.lua"))()("Module")
...
Aiming.AimLock = {
    ...
    Keybind = Enum.KeyCode.E, -- // You can also have Enum.UserInputType.MouseButton2, etc.
}
